...
3. Parses source with `ra_ap_syntax` and injects timing guards into matched functions (including `impl Future` functions, trait implementations, and functions defined inside `macro_rules!`)
